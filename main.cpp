...
void draw(SDL_Window * window)
{
	...
	glBindBuffer(GL_PIXEL_PACK_BUFFER, 0);
	glReadPixels(400, 300, 1, 1, GL_RGB, GL_UNSIGNED_BYTE, pixelColour);
	cout << " r : " << pixelColour[0] / 255.0 << "\n";
	cout << " g : " << pixelColour[1] / 255.0 << "\n";
	cout << " b : " << pixelColour[2] / 255.0 << "\n";



	if (pixelColour[1]/255.0 > 0.11)
	{
		cout << "green \n" << pixelColour[i] /255.0;
	}
